-- Complete RLS setup for all tables (FIXED VERSION)
...
-- ============================================================================
-- LOGS - Users see all logs (no execution_id filtering for system logs)
-- ============================================================================
...
TO authenticated
USING (
    -- Allow if execution_id is null (system logs) OR belongs to user's pipeline
...
TO authenticated
USING (
    -- Allow if execution_id is null OR belongs to user's pipeline
    execution_id IS NULL OR
    EXISTS (
        SELECT 1 FROM public.executions e
        JOIN public.pipelines p ON p.id = e.pipeline_id
...
-- ============================================================================
-- METRICS - All authenticated users can view all metrics
-- (metrics table doesn't have execution_id, it's system-wide)
-- ============================================================================
